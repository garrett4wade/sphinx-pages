...
echo "sphinx-build -b html $docs_src/$INPUT_SOURCE_DIR/source $docs_html -E -d $sphinx_doctree"
sphinx-build -b html $docs_src/$INPUT_SOURCE_DIR/source $docs_html -E -d $sphinx_doctree
echo ::endgroup::
